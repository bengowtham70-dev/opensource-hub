...
const CHANNELS = [
  ...
  },
  {
    ...
    label: "Homebrew",
    prompt: "$ ",
    cmd: "brew install bengowtham70-dev/tap/opensource-hub",
    highlight: "bengowtham70-dev/tap/opensource-hub",
  ...
  },
  {
    ...
    label: "Curl / POSIX",
    prompt: "$ ",
    cmd: "curl -fsSL https://raw.githubusercontent.com/bengowtham70-dev/opensource-hub/main/install.sh | sh",
